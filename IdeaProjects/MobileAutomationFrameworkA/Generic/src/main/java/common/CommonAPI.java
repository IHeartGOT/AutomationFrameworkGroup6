...
public class CommonAPI {
    ...
    public String browserstack_username= "alexkarmokar1";
    public String browserstack_accesskey = "hq6pQsHhxp5AU22zL49J";
    public String saucelabs_username = "Alexkarmokar";
    public String saucelabs_accesskey = "835cc7d5-8f30-4bd4-9620-3a3524c4e10b";

    @Parameters({"filepath","fileName","OS", "appType", "deviceType", "deviceName", "version"})
    @BeforeMethod
    public void setUp(String filepath,String fileName,@Optional("Android") String OS, @Optional("Phone") String appType, @Optional("Emulator") String deviceType, @Optional("Nexus") String deviceName,
...
//                //NYP APP
                appDirectory = new File("../NYPost/src/app/nyp.apk");
                //NYP APP
               ...
               // EBAY APP
                ...
                appDirectory= new File("/Users/alexkarmokar/IdeaProjects/MobileAutomationFrameworkA/UIcatalog/src/app");
